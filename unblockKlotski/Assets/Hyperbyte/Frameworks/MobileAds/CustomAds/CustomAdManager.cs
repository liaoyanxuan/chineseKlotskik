...
namespace Hyperbyte.Ads
{
	...
	public class CustomAdManager : AdHelper
    {
        ...
        {
            BannerAdAdManagement.getInstance.showBanner();
        }
        ...
        {
            BannerAdAdManagement.getInstance.hideBanner();
        }
        ...
        public override bool IsInterstitialAvailable()
        {
            ...
            bool isAvailable =InterialAdManagement.getInstance.isInterstitialAvailable();
        ...
        {
            InterialAdManagement.getInstance.UserChoseToWatchAd("ShowInterstitial", OnInterstitialShowEvent,closeCallBack);
        }

        // Checks if rewarded ad available.
        public override bool IsRewardedAvailable()
        {
            return AdManagement.getInstance.isRewardedAvailable();
        }

        // Shows rewarded ad if loaded.
        public override void ShowRewarded()
        {
            AdManagement.getInstance.UserChoseToWatchAd("ShowRewarded", OnRewardedAdReceivedRewardEvent);
        }
        ...
        private void OnInterstitialShowEvent(bool adUnitId) {
            RequestInterstitial();
        ...
        private void OnRewardedAdReceivedRewardEvent(bool suss,string adtype) {
