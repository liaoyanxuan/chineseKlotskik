...
namespace Hyperbyte.Ads
{
    ...
    {
        public static bool adobjectInit=false;
        ...
        float lastInterstitialShownTime = -60f;
        ...
        /// </summary>
        public void ShowInterstitial(Action<bool> closeCallBack)
        {
            ...
            if (adSettings.adsEnabled && adSettings.interstitialAdsEnabled)
            {
                ...
                if (lastInterstitialShownTime <= 0 || ((Time.time - lastInterstitialShownTime) >= adSettings.delayBetweenIngerstitials))
                {
                    ...
                    parameters[0] = closeCallBack;

                    info.Invoke(adBehaviour, parameters);
...
#region Callback Integration
        ...
        {
            MonoBehaviour.print("AdManager-->OnInterstitialShown");
        ...
        public void OnRewardedClosed() { if (OnRewardedClosedEvent != null) { OnRewardedClosedEvent.Invoke(rewardedVideoTag); } }
