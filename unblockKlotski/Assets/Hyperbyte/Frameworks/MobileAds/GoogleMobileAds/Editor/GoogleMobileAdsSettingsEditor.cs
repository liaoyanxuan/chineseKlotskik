...
{	
	...
	public class GoogleMobileAdsSettingsEditor : CustomInspectorHelper 
	{
        ...
        private SerializedProperty openId_android;
        ...
        private SerializedProperty openId_iOS;
		...
		public override void OnInspectorGUI()
    	{
			...
			if (!cache) 
			{
                ...
                openId_android = serializedObject.FindProperty("openId_android");
                ...
                openId_iOS = serializedObject.FindProperty("openId_iOS");
		...
		void DrawAdsSettings() 
		{
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Open Ad Unit Id : ", labelStyle, GUILayout.MaxWidth(140));
            openId_android.stringValue = EditorGUILayout.TextField(openId_android.stringValue);
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Open Ad Unit Id : ", labelStyle, GUILayout.MaxWidth(140));
            openId_iOS.stringValue = EditorGUILayout.TextField(openId_iOS.stringValue);
            EditorGUILayout.EndHorizontal();
