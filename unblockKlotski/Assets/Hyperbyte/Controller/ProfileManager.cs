...
namespace Hyperbyte
{
    ...
    public class ProfileManager : Singleton<ProfileManager>
    {
        ...
        public void initProfileStatus()
        {
            ...
            PlayerPrefs.SetInt("isUserAdFree", 0);
            isUserAdFree = false;
        }
        ...
        {
            string key = "bestScore_" + gameMode;
        ...
        /// </summary>
        public void SetBestScore(int score, string gameMode)
        {
        ...
        /// 获取总分
        /// </summary>
        public int GetTotalScore(string gameMode)
        {
            string key = "totalScore_" + gameMode;
            if (PlayerPrefs.HasKey(key))
            {
                return PlayerPrefs.GetInt("totalScore_" + gameMode, 0);
            }
            else
            {
                return 0;
        ...
        /// 设置总分
        /// </summary>
        public void SetTotalScore(int score, string gameMode)
        {
            PlayerPrefs.SetInt("totalScore_" + gameMode, score);
