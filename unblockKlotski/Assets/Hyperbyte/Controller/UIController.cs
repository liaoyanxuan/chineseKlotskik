...
namespace Hyperbyte
{
    ...
    public class UIController : Singleton<UIController>
    {
        ...
        public GameObject adBreakRewardScreen;
        public GameObject introduceScreen;
        
        public GameObject tipView;
        public GameObject toolUseQuery;

        public GameObject leaderBoardLogin;
        public GameObject gameLeaderBoard;

        public GameObject realNameVerify;
        ...
        [SerializeField]
        private GameObject loadingTips;
        [SerializeField]
        private GameObject alertTips;
        ...
        private void ShowReviewPopup()
        {
            ...
            Debug.Log("canShowReviewPopup:"+ canShowReviewPopup);
           //iOS会控制弹出次数，无需自己控制；测试，是否有弹窗都会返回true还是要提交评价后才返回true
        ...
        {
            currencyBalanceButton.gameObject.SetActive(true);
        ...
        public void DisableCurrencyBalanceButton()
        {
            ...
            if (currencyBalanceButton != null && currencyBalanceButton.activeSelf)
            {
                ...
                Timer.Schedule(this, 0.5f, () => {
                    currencyBalanceButton.gameObject.SetActive(false);
                });
        ...
        /// Disable currency balance button.
        /// </summary>
        public void DisableCurrencyBalanceButton2()
        {
           if(selectThemeScreen==null|| rescueGameScreen == null || gameOverScreen == null || shopScreen == null || purchaseSuccessScreen == null)
            {
                return;
            }
        ...
        public void PlayAddGemsAnimationAtPosition(Vector3 position, float delay)
        {
            ...
            rewardAnim.GetComponent<RectTransform>().position = position;  //这是世界坐标
        ...
        public void ShowAlertTip(string tipMsg)
        {
            alertTips.GetComponent<AlertTipsScript>().showTips(tipMsg);
            alertTips.Activate();
        }

        public void ShowAlertTipWithNo(string tipMsg, string yesDesc, string NoDesc,Action yesHandle, Action noHandle)
        {
            alertTips.GetComponent<AlertTipsScript>().showTipsWithNo(tipMsg,yesDesc,NoDesc,yesHandle,noHandle);
            alertTips.Activate();
        }
        ...
        public void ShowLoadingTip()
        {
            ...
            loadingTips.GetComponent<LoadingTipsScript>().ShowLoadingTip();
        ...
        public void HideLoadingTip()
        {
            ...
            loadingTips.GetComponent<LoadingTipsScript>().HideLoadingTip();
