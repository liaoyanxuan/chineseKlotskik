...
namespace LeaderBoardSuperScrollView
{
    ...
    public class LeaderBoardDataSourceMgr : MonoBehaviour
    {
        ...
        static LeaderBoardDataSourceMgr instance = null;

        public static LeaderBoardDataSourceMgr Get
        {
            get
            {
                if (instance == null)
                {
                    instance = Object.FindObjectOfType<LeaderBoardDataSourceMgr>();
                }
                return instance;
            }
        ...
        public void RequestLoadMoreDataList(int loadCount,System.Action onLoadMoreFinished)
        {
            ...
            PlayFabLeaderboardManager.getInstance().RequestLoadMoreDataList(onLoadMoreFinished);
        }
        ...
        public void InsertSourceData(int Position, string DisplayName, int StatValue,string playFabId)
        {
            ItemData tData = new ItemData();
            tData.mId = Position;
            tData.mName = DisplayName;
            tData.mDesc = StatValue.ToString();
            tData.playFabId = playFabId;
            InsertData(Position, tData);
        ...
        void DoRefreshDataSource()
        {
            ...
            for (int i = 0; i < mTotalDataCount; ++i)
            {
                ...
                tData.mIcon = LeaderBoardResManager.Get.GetSpriteNameByIndex(Random.Range(0, 24));
