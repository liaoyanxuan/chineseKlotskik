...
public class PlayFabAuthServiceForManager
{
    ...
    private const string _DisplayNameIdKey = "PlayFabDisplayNameIdKey";

    public static PlayFabAuthServiceForManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = new PlayFabAuthServiceForManager();
            }
            return _instance;
        }
    }

    private static PlayFabAuthServiceForManager _instance;

    public PlayFabAuthServiceForManager()
    {
        _instance = this;
    }
    ...
    public string tempDisplayNameId=null;
    ...
    public string RememberMeDisplayNameId
    {
        get
        {
            return PlayerPrefs.GetString(_DisplayNameIdKey, "");
        }
        set
        {
          
            PlayerPrefs.SetString(_DisplayNameIdKey, value);
        }
    }
