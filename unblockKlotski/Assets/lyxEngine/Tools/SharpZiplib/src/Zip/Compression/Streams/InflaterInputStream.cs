...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	public class InflaterInputBuffer
	{
        ...
        public InflaterInputBuffer(Stream stream, byte[] buff)
        {
            inputStream = stream;
        
            if (buff.Length < 1024)
                throw new Exception("bufferSize is short than 1024");
            rawData = buff;
            clearText = rawData;
        }
		#endregion
	...
	public class InflaterInputStream : Stream
	{
        ...
        public InflaterInputStream(Stream baseInputStream, Inflater inflater, byte[] buff)
        {
            if (baseInputStream == null)
            {
                throw new ArgumentNullException("baseInputStream");
            ...
            inputBuffer = new InflaterInputBuffer(baseInputStream, buff);
        }
		#endregion
